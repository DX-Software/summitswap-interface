...
export const BSC_NETWORK_URL = `${process.env.REACT_APP_BSC_NETWORK_URL}`
export const ETH_NETWORK_URL = `${process.env.REACT_APP_ETH_NETWORK_URL}`
...
export const BSC_CHAIN_ID = parseInt(process.env.REACT_APP_CHAIN_ID ?? '56')

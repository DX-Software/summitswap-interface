...
export const ADDITIONAL_ROUTER_ADDRESS = `${process.env.REACT_APP_ADDITIONAL_ROUTER_ADDRESS}`
export const ADDITIONAL_FACTORY_ADDRESS = `${process.env.REACT_APP_ADDITIONAL_FACTORY_ADDRESS}`
export const ADDITIONAL_INIT_CODE_HASH = `${process.env.REACT_APP_ADDITIONAL_INIT_CODE_HASH}`

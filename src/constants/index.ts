...
export const CREATE_STANDARD_TOKEN_ADDRESS = `${process.env.REACT_APP_CREATE_STANDARD_TOKEN_ADDRESS}`
export const CREATE_LIQUIDITY_TOKEN_ADDRESS = `${process.env.REACT_APP_CREATE_LIQUIDITY_TOKEN_ADDRESS}`
export const CREATE_BABY_TOKEN_ADDRESS = `${process.env.REACT_APP_CREATE_BABY_TOKEN_ADDRESS}`
export const CREATE_BUYBACK_TOKEN_ADDRESS = `${process.env.REACT_APP_CREATE_BUYBACK_TOKEN_ADDRESS}`
export const CREATE_TOKEN_FEE_RECEIVER_ADDRESS = `${process.env.REACT_APP_CREATE_TOKEN_FEE_RECEIVER_ADDRESS}`

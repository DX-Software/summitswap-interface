...
export const mainnetTokens = {
  ...
  beth: new Token(
    ...
    "BETH",
    "Binance Beacon ETH",
    //ethereum.org/en/eth2/beacon-chain/"
  ),
  mamzn: new Token(
    MAINNET,
  ...
  lazio: new Token(
    ...
    "LAZIO",
    "FC Lazio Fan Token",
    //launchpad.binance.com/en/subscription/LAZIO_BNB"
  ),
  arv: new Token(
    MAINNET,
  ...
  porto: new Token(
    ...
    "PORTO",
    "FC Porto Fan Token",
    //launchpad.binance.com/en/subscription/PORTO_BNB"
  ),
  kart: new Token(
    MAINNET,
  ...
  santos: new Token(
    ...
    "SANTOS",
    "FC Santos Fan Token",
    //launchpad.binance.com/en/launchpool/SANTOS_BNB"
  ),
  nabox: new Token(
    MAINNET,

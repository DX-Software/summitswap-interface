import { Currency, ETHER, JSBI, TokenAmount } from '@summitswap-libs'
...
export default function PoolFinder() {
  ...
  const prerequisiteMessage = (
    <LightCard padding="45px 10px">
      <Text color='sidebarColor' style={{ textAlign: 'center' }}>
            ...
            {currency0 && currency1 ? (
              pairState === PairState.EXISTS ? (
                hasPosition && pair ? (
                  ...
                  <LightCard marginTop='24px' padding="45px 10px">
                ...
                <LightCard marginTop='24px' padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text color='sidebarColor' fontFamily='Poppins' style={{ textAlign: 'center' }}>

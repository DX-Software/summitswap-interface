const analyzeOne = require('./for_csv_report.js');
...
const csvWriter = createCsvWriter({
  ...
  header: [
    ...
    { id: "transferFailsRatio", title: "fail per transfer" },
    { id: "revLikelihood", title: "reverse likelyhood" },
    { id: "failRatio", title: "failing ratio" },
    { id: "script", title: "verification status" },
    { id: "non_transfers_ratio", title: "non-transfers ratio" },
    { id: "non_transfers_mean_deviation", title: "non transfers mean deviation" },
...
async function repgen() {
  ...
  for (let TokenAddress of Object.keys(Tokens)) {
    per++;
    let obj = await analyzeOne(TokenAddress, Tokens, TestResults);
    tocsv.push(obj);
